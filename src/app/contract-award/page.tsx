...
<span className="material-symbols-outlined text-[14px]">chevron_right</span>
<span className="font-tabular-num text-tabular-num text-on-surface">GEM/2026/B/489201</span>
<span className="material-symbols-outlined text-[14px]">chevron_right</span>
...
<p className="font-body-sm text-body-sm text-on-surface-variant">
            Tender Ref: <strong className="text-on-surface font-tabular-num">GEM/2026/B/489201</strong> • Procurement of High-Precision Biomedical &amp; Diagnostic Equipment • Sanctioned Allocation: <strong className="text-on-surface font-tabular-num">₹41,20,00,000</strong> (Split 50:50 under Public Procurement Preference to Make in India Order)
          </p>
</div>
...
{/* Supplier 1: Apex Heavy Diagnostic Systems */}
...
<h3 className="font-title-sm text-title-sm text-on-surface font-bold mt-1.5">Apex Heavy Diagnostic Systems Ltd</h3>
...
<span className="font-tabular-num text-tabular-num text-on-surface font-bold">₹20,60,00,000</span>
</div>
<div>
<span className="font-label-sm text-label-sm text-on-surface-variant block">Required e-PBG (5%)</span>
<span className="font-tabular-num text-tabular-num text-on-surface font-bold">₹1,03,00,000</span>
</div>
</div>
...
<h3 className="font-title-sm text-title-sm text-on-surface font-bold mt-1.5">ABC Industries Medical Division Ltd</h3>
...
<span className="font-tabular-num font-bold text-on-surface text-tabular-num">₹1,03,00,000</span>
...
<div className="w-full h-44 rounded-lg bg-cover bg-center shadow-inner" data-location="All India Institute of Medical Sciences, New Delhi, India" style={{backgroundImage: "url('https"}}></div>
...
<div className="w-full h-44 rounded-lg bg-cover bg-center shadow-inner" data-location="Postgraduate Institute of Medical Education and Research, Chandigarh, India" style={{backgroundImage: "url('https"}}></div>
...
<path d="M0 35 L20 28 L40 32 L60 18 L80 24 L100 12 L120 16 L140 8 L160 22 L180 14 L200 19 L220 11 L240 15 L260 7 L280 12 L300 9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
<path d="M0 35 L20 28 L40 32 L60 18 L80 24 L100 12 L120 16 L140 8 L160 22 L180 14 L200 19 L220 11 L240 15 L260 7 L280 12 L300 9 L300 40 L0 40 Z" fill="currentColor" fill-opacity="0.08"></path>
</svg>
</div>
</div>
</div>
