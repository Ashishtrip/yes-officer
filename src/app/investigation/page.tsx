...
<path className="text-on-surface" d="M 40 0 L 0 0 0 40" fill="none" stroke="currentColor" stroke-width="0.7"></path>
</pattern>
</defs>
...
<path className="animate-pulse" d="M 50% 50% L 20% 28%" stroke="#ba1a1a" stroke-dasharray="6,4" stroke-width="2.5"></path>
{/* Noida Hub to Bidder B */}
<path className="animate-pulse" d="M 50% 50% L 80% 28%" stroke="#ba1a1a" stroke-dasharray="6,4" stroke-width="2.5"></path>
{/* Noida Hub to Bidder C */}
<path d="M 50% 50% L 25% 78%" stroke="#ffb95f" stroke-width="2.5"></path>
{/* Noida Hub to Bidder D */}
<path d="M 50% 50% L 75% 78%" stroke="#00236f" stroke-dasharray="3,3" stroke-width="2"></path>
{/* Direct Subnet Link between Bidder A & Bidder B */}
<path d="M 20% 28% Q 50% 12% 80% 28%" stroke="#ba1a1a" stroke-dasharray="4,4" stroke-width="2.5"></path>
</svg>
{/* Top Row Nodes */}
