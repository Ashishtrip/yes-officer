...
<a className="text-on-primary underline hover:text-secondary-fixed transition-colors" href="#rti-filing">DoPT RTI Portal Link</a>
</div>
</div>
{/* Main Context Area */}
...
<option>All Participating Ministries (12)</option>
...
<a className="inline-flex items-center gap-1 text-[11px] font-label-md text-primary hover:underline bg-surface-container px-2 py-1 rounded" href="#view-gazette-1">
...
<td className="py-3 px-3 align-top text-right">
<a className="inline-flex items-center gap-1 text-[11px] font-label-md text-primary hover:underline bg-surface-container px-2 py-1 rounded" href="#view-gazette-2">
<span className="material-symbols-outlined text-[14px]">picture_as_pdf</span> Notice
                    </a>
</td>
</tr>
...
<td className="py-3 px-3 align-top text-right">
<a className="inline-flex items-center gap-1 text-[11px] font-label-md text-primary hover:underline bg-surface-container px-2 py-1 rounded" href="#view-gazette-3">
<span className="material-symbols-outlined text-[14px]">picture_as_pdf</span> Notice
                    </a>
</td>
</tr>
...
<a className="text-[11px] font-label-md text-primary font-semibold hover:underline mt-1" href="#verify-hash">
...
<a className="h-8 px-3 rounded-lg bg-primary text-on-primary font-label-md text-label-md hover:bg-primary-container transition-colors inline-flex items-center gap-1" href="https://rtionline.gov.in" rel="noopener noreferrer" target="_blank">
